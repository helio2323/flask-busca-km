...
def test_rotas_brasil_direct_api():
    print("=== CHAMADA DIRETA PARA API ROTAS BRASIL ===")
    print("Rota: Guarulhos -> Recife")
    ...
    # Coordenadas aproximadas de Guarulhos e Recife
    ...
    try:
        ...
        url = f"{base_url}?pontos={pontos}&alternatives=true&eixos=2&veiculo=1&st=false&combustivel=&consumo=&evitarPedagio=false&recaptchaRespostaCliente={params['recaptchaRespostaCliente']}&recaptchaRespostaV3=true&evitarBalsa=false&meioPagamento=&fornecedorPagamento=&dataTarifa=2024-02-29"
        ...
        if response.status_code == 200:
            ...
            if 'routes' in data and data['routes']:
                ...
                with open('rotas_brasil_response_guarulhos_recife.json', 'w', encoding='utf-8') as f:
                    json.dump(data, f, indent=2, ensure_ascii=False)
                print(f"\n[OK] Resposta salva em 'rotas_brasil_response_guarulhos_recife.json'")
