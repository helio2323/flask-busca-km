...
def test_no_cache_system():
    print("=== TESTE DO SISTEMA SEM CACHE ===")

    # 1. Criar um novo grupo
    print("\n1. Criando grupo...")
    grupo_data = {
        "nome": "Teste Sem Cache",
        "descricao": "Teste com cache desabilitado - sempre API Rotas Brasil"
    }
    grupo_id = None
    try:
    ...
    # 2. Criar um arquivo Excel de teste com 2 rotas
    ...
    upload_id = None
    try:
        files = {'file': ('test_no_cache.xlsx', output.read(), 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')}
