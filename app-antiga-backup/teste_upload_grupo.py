...
# Dados de teste
dados_teste = {
    'origem': ['São Paulo SP', 'Rio de Janeiro RJ', 'Belo Horizonte MG'],
    'destino': ['Guarulhos SP', 'Niterói RJ', 'Contagem MG']
}
...
files = {'file': ('teste_rotas.xlsx', output.read(), 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')}
params = {'grupo_id': 3}

print("🚀 Fazendo upload da planilha para o grupo...")
