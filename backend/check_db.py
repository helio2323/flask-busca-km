...
print('\n=== CONSULTAS NO BANCO ===')
cursor.execute("SELECT id, origem, destino, distancia, pedagios, data_consulta, grupo_id FROM consultas WHERE grupo_id = 3 ORDER BY data_consulta DESC")
...
cursor.execute("SELECT id, origem, destino, distancia, pedagios, data_consulta, grupo_id FROM consultas ORDER BY data_consulta DESC LIMIT 10")
consultas = cursor.fetchall()
